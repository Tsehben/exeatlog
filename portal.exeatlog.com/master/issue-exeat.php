...
<select class="custom-select pull-right" name='form'>
							 ...
							 <label class="col-md-12"><b>Type of Exeat</b></label></b>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"><b>Period of Exeat( hours )</b></label></b>
                                        <div class="col-md-12">
                                            <?php
                                            include('config1.php');
					...
					$sql_run=mysqli_query($conn4,$sql);
						...
						$row =mysqli_fetch_assoc($sql_run);
					        $maxperiod =$row["maxperiodi"];
					        
                                            
                                           echo' <div class="form-group"><input type="number" name="period" min="1" max="'.$maxperiod.'" step="1" value="1" ></div>';
						}
                                            ?>
                                        </div>
                                    </div>
                              ...
                              <a  href="printexeat1.php" ><img src="print.png" style="width:50px; float:right; height:50px;"/> </a>                               
								</div>
                                								</div>
                                </form>
