...
<div id="Main_wrapper">
<a href= "exeatlog.php">View Exeat Log</a>
<center><p class="header">Fill out the following for to issue exeat:</p></center>
<form action="special_exeat.php" method="post">
...
<a href="masters_page.php" class="type"><input  name="" type="radio" />Normal</a>
<a href="special_exeat.php" class="type"><input  name="" type="radio" checked="checked"/>Special</a>
...
$house =$_SESSION['house'];
$reason =$_POST['reason'];
$issuedate = gmdate("l F jS, Y - g:ia",time()+3600);
$period =$_POST['period'];
