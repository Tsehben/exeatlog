...
<body class="form-v8">
	...
	<div class="form-v8-content">
			...
			<div class="form-right">
				...
				<div class="tab">
					<div class="tab-inner">
						<button class="tablinks" onclick="openCity(event, 'sign-up')" id="defaultOpen">Administrator</button>
					</div>
					<div class="tab-inner">
	...
	<div class="center-on-page">
						...
						<div class="form-row-last">
							...
							<input type="submit" style="background:none; color:white; border:none;" name="forget1" value=" I forgot my password?"/>
