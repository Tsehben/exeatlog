					...
					<div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material" >
								 <h4 class="card-title m-t-10">School Profile </h4></br>
                                    <div class="form-group">
                                        <label class="col-md-12"><b>Full Name Of School</b></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="E.g. Presbyterian Boys' Secondary School" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"><b>School's Address</b></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="E.g. P.O. Box 77" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <script class="jsbin" src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
                                              <div class="file-upload">
                                                <button class="btn btn-success" type="button" onclick="$('.file-upload-input').trigger( 'click' )">Add Image</button>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" type="submit">Update School Profile </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
