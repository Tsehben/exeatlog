...
<p class="header">Change Current Password</p>
</br>
...
$query="SELECT *FROM user where password='$password' AND username='Admin'";
$query_run =mysqli_query($conn,$query);

if(mysqli_num_rows($query_run)>0){
$query="UPDATE user SET password='$new_password' WHERE username='Admin'";
$query_run=mysqli_query($conn,$query);
}
else{
