                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material"  method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="E.g. Clerk" class="form-control form-control-line" name="house" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"><b>Housemaster's Name</b></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="E.g. Raymond Asamoah" class="form-control form-control-line" name="name">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" placeholder=" ablorh234@gmail.com" name="email" class="form-control form-control-line">
                                        </div>
                                    </div>
  ...
  $.ajax({
   ...
   success:function(data)
   {
    for(var count=0; count<data.length; count++)
    {
     ...
     html_data += '<td data-name="email" class="email" data-type="text" data-pk="'+data[count].id+'">'+data[count].email+'</td></tr>';
