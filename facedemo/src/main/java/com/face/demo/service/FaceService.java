...
public class FaceService {
    ...
    public static final String storageConnectionString =
    		...
    		+ "AccountName=exeatlogfacestorage;"
    		+ "AccountKey=rYD17G5UZNsk1XtDbukk9SPn4UjjKxcRla4Yy/gVQBQLnpzOvLk6dqx7ssFfjHVD/KZY3f78Zv/Ma56DKp7pvA==";
    
    private static final String blobImageContainer = "photos";
    private static final String unknownBlobImageContainer = "unknowns";
	
	private static final String faceApikey = "f86aef88194f4b0fa9febbfd03165677";
