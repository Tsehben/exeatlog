...
<html lang="en">
  ...
  <body>
	    		...
	    		<div class="col-lg-8 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md topper d-flex align-items-center justify-content-end">
						    	...
						    	<img src="images/logo.png" width="95" height="95" style="padding:5px 0px;" />
						   
					   
					    
					    	<p class="mb-0">
					    		 <img src="images/label.jfif" style="padding:0px;" />
					    	</p>
					    </div>
				    </div>
			    </div>
	...
	<section class="ftco-section" id="nondegree">
		<div class="container-fluid px-4">
					<center>
					<span><h3>Create an Account Now!</h3></span>
					<br><h4><span>Enter the requisite credentials to create your account and access the admission portal</span></h4>
					</center>
					<center><br>
					<div class="form-v8-content">
					
						<form method="POST" >
							<label><b>Username</b></label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							<input type="text" name="user" placeholder="Enter a username "required><br><br>
							<label><b>Your Email </b></label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							<input type="email" name="email" placeholder="Enter your email"required><br><br>
							<label><b>New Password</b></label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							<input type="password" name="npassword" required><br><br>
							<label><b>Confirm Password</b></label>
							<input type="password" name="cpassword" required><br><br>
							&nbsp&nbsp&nbsp&nbsp<input type="submit" name="signup" class="btn btn-primary" value="S I G N U P"/>
						</form><br>
						<?php
						include('adduser.php');
						?>
